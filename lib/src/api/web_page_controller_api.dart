...
class WebPageControllerApi {
  ...
  Future<Response<void>> indexNewPage({ 
    required WebPageUrlDto webPageUrlDto,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<WebPage>] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BuiltList<WebPage>>> searchForRecipe({ 
    ...
    BuiltList<WebPage> _responseData;
